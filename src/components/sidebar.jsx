...
async function Sidebar({ data: { users } }) {
  ...
  return (
    <>
      ...
      <div class="app-brower-inner">
        <div class="app-brower-inner-content">
          <div class="app-brower-inner-list">
            <div class="app-brower-inner-list-items">
              <MainNavigations />
...
export default function (props) {
  return (
    <>
      ...
      <div
        className="app-brower"
        position="left"
        class="app-brower"
        align="start"
        role="navigation"
      >
        <div className="app-brower-content">
          <Suspense fallback={<></>}>
            <Sidebar {...props} />
          </Suspense>
        </div>
